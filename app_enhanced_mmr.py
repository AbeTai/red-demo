...
# ページ設定
st.set_page_config(
    page_title="Music Recommender Demo (Enhanced with MMR)",
    page_icon="🎵",
    layout="wide"
)
...
def main():
    st.title("🎵 Music Recommender Demo (Enhanced with MMR)")
    ...
    # フッター
    st.markdown("---")
    st.markdown("Built with Streamlit and Implicit ALS - Enhanced with Demographics Filtering and MMR")
